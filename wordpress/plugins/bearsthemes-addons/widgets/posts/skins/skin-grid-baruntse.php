...
class Skin_Grid_Baruntse extends Skin_Base {
	...
	public function get_title() {
		return __( 'Grid Baruntse', 'bearsthemes-addons' );
	}
        ...
        <div class="elementor-post__content">
          ...
          <?php
						if( '' !== $this->parent->get_instance_value_skin('show_read_more') ) {
							echo '<a class="elementor-post__read-more" href="' . get_the_permalink() . '">' . $this->parent->get_instance_value_skin('read_more_text') . bearsthemes_addons_get_icon_svg( 'chevron-right', 10 ) . '</a>';
						}
					?>
        </div>
			</article>
