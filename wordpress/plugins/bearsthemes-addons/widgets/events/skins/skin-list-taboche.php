...
class Skin_List_Taboche extends Skin_Base {
	...
	public function get_title() {
		return __( 'List Taboche', 'bearsthemes-addons' );
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
	...
	protected function render_post() {
        ...
        ?>
          ...
          if( $venue_id ) {
            echo '<div class="elementor-event__address">' . bearsthemes_addons_get_icon_svg( 'map-marker', 14 );
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_read_more' ) ) {
              echo '<a class="elementor-event__read-more" href="' . get_the_permalink() . '">'  . esc_html__( 'Read More', 'bearsthemes-addons' ) . '</a>';
            }
          ?>
