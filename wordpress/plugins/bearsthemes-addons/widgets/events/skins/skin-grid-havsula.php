        ...
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) { ?>
          <div class="elementor-event__thumbnail">
            ...
            <?php
              ...
              if( '' !== $this->parent->get_instance_value_skin( 'show_read_more' ) ) {
                echo '<a class="elementor-event__read-more" href="' . get_the_permalink() . '">' . bearsthemes_addons_get_icon_svg( 'chevron-right', 16 ) . '</a>';
              }
            ?>
  				</div>
  			<?php } ?>
          ...
          <?php if( '' !== $this->parent->get_instance_value_skin( 'show_meta' ) ) { ?>
	          <ul class="elementor-event__meta">
	              ...
	              if( $venue_id ) {
	                echo '<li class="address">' . bearsthemes_addons_get_icon_svg( 'location', 14 );
	                  $this->parent->event_addres( $venue_id );
	                echo '</li>';
	              }

                echo tribe_events_event_schedule_details( get_the_ID(), '<li class="date">' . bearsthemes_addons_get_icon_svg( 'clock', 14 ), '</li>' );
	    				?>
	          </ul>
					<?php } ?>
				</div>
