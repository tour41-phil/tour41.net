...
class Skin_Jorasses extends Skin_Base {
	...
	public function get_title() {
		return __( 'Jorasses', 'bearsthemes-addons' );
	}
	...
	public function register_layout_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Support A <br>Party', 'bearsthemes-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Alienum phaedrum torquatos nec eu, vis detraxit periculis ex.', 'bearsthemes-addons' ),
			]
		);
	...
	public function register_design_give_form_section_controls( Widget_Base $widget ) {
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-jorasses .give-total-wrap #give-amount,
					 .mfp-wrap form.elementor-give-modal--skin-jorasses #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-jorasses #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-jorasses .give-total-wrap .give-currency-symbol,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-jorasses .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-jorasses #give-donation-level-button-wrap .give-btn:hover,
					 .mfp-wrap form.elementor-give-modal--skin-jorasses #give-donation-level-button-wrap .give-btn.give-default-level,
					 .mfp-wrap form.elementor-give-modal--skin-jorasses #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-jorasses .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.mfp-wrap form.elementor-give-modal--skin-jorasses .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
	...
	public function render() {
		...
		?>
			...
			<div class="elementor-gt-header">
				<?php
          echo '<div class="elementor-gt-header__icon">' . bearsthemes_addons_get_icon_svg( 'lifesaver', 50 ) . '</div>';
