	...
	public function register_layout_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Alienum phaedrum torquatos nec eu, vis detrax culis ex, nihis in mei.', 'bearsthemes-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-pumori .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-pumori #give-gateway-radio-list > li label:hover,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-pumori .give-submit:hover' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-pumori #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-pumori .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-pumori #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-pumori .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} form[id*=give-form],
											 ...
											 .mfp-wrap form.elementor-give-modal--skin-pumori',
				'condition' => [
					'form_id!'=> '',
				],
			]
