		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap  form.elementor-give-modal--skin-baruntse .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap  form.elementor-give-modal--skin-baruntse #give-gateway-radio-list > li label:hover,
					 ...
					 .mfp-wrap  form.elementor-give-modal--skin-baruntse .give-submit:hover' => 'color: {{VALUE}};',
					'.mfp-wrap  form.elementor-give-modal--skin-baruntse #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 ...
					 .mfp-wrap  form.elementor-give-modal--skin-baruntse .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap  form.elementor-give-modal--skin-baruntse #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap  form.elementor-give-modal--skin-baruntse .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
