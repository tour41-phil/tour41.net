	...
	public function register_design_give_form_section_controls( Widget_Base $widget ) {
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-wilson .give-total-wrap #give-amount,
					 .mfp-wrap form.elementor-give-modal--skin-wilson #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-wilson #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-wilson .give-total-wrap .give-currency-symbol,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-wilson .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-wilson #give-donation-level-button-wrap .give-btn:hover,
					 .mfp-wrap form.elementor-give-modal--skin-wilson #give-donation-level-button-wrap .give-btn.give-default-level,
					 .mfp-wrap form.elementor-give-modal--skin-wilson #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-wilson .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.mfp-wrap form.elementor-give-modal--skin-wilson .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
