...
class Skin_Tronador extends Skin_Base {
	...
	public function get_title() {
		return __( 'Tronador', 'bearsthemes-addons' );
	}
	...
	public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-tronador #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-tronador #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-tronador #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 ...
					 .mfp-wrap form.elementor-give-modal--skin-tronador .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-tronador #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-tronador .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.mfp-wrap form.elementor-give-modal--skin-tronador .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
