...
class Skin_Andrus extends Skin_Base {
	...
	public function get_title() {
		return __( 'Andrus', 'bearsthemes-addons' );
	}
	...
	public function register_layout_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Coronavirus Relief Fund', 'bearsthemes-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'bearsthemes-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-gf-form form[id*=give-form] .give-btn-modal,
					...
					'{{WRAPPER}} .elementor-gf-form form[id*=give-form] #give-donation-level-button-wrap .give-btn.give-default-level:hover' => 'color: #333333;',
					'.mfp-wrap form.elementor-give-modal--skin-andrus #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give-gateway-radio-list > li label:hover,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give_terms_agreement label:hover,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give_terms_agreement input[type=checkbox]:checked + label,
					 .mfp-wrap form.elementor-give-modal--skin-andrus .give_terms_links,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-andrus #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .mfp-wrap form.elementor-give-modal--skin-andrus #give-final-total-wrap .give-donation-total-label,
					 .mfp-wrap form.elementor-give-modal--skin-andrus .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-andrus #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-andrus .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-gf-form form[id*=give-form] .give-btn-modal:hover,
					 .mfp-wrap form.elementor-give-modal--skin-andrus .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} form[id*=give-form],
											 ...
											 .mfp-wrap form.elementor-give-modal--skin-andrus',
				'condition' => [
					'form_id!'=> '',
				],
			]
