    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.mfp-wrap form.elementor-give-modal--skin-nuptse #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give-gateway-radio-list > li label:hover,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give_terms_agreement label:hover,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give_terms_agreement input[type=checkbox]:checked + label,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse .give_terms_links,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-nuptse #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse #give-final-total-wrap .give-donation-total-label,
					 .mfp-wrap form.elementor-give-modal--skin-nuptse .give-submit' => 'background-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-nuptse #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
					'.mfp-wrap form.elementor-give-modal--skin-nuptse .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.mfp-wrap form.elementor-give-modal--skin-nuptse .give-submit:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'form_id!'=> '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} form[id*=give-form],
											 ...
											 .mfp-wrap form.elementor-give-modal--skin-nuptse',
				'condition' => [
					'form_id!'=> '',
				],
			]
