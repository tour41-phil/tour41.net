        ...
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) { ?>
                ...
                if( $organizer_id ) {
                  echo '<div class="elementor-event__organizer">
                          ...
                          <div class="infor">' .
                            ...
                            '<span>' . esc_html__('Organized ', 'bearsthemes-addons') . '</span>' .
                         '</div>
                        </div>';
                }
          ...
          <?php } ?>
            ...
            if( '' !== $this->parent->get_instance_value_skin( 'show_date' ) ) {
              echo tribe_events_event_schedule_details( get_the_ID(), '<div class="elementor-event__date">' . __('Started: ', 'bearsthemes-addons'), '</div>' );
            }
          ?>
				</div>
			</article>
