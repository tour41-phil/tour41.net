			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-give-form .give-btn-modal' => 'background-color: {{VALUE}};',
					 '.mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give-total-wrap #give-amount,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-gateway-radio-list > li label:hover,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-gateway-radio-list > li.give-gateway-option-selected label,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give_terms_agreement label:hover,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give_terms_agreement input[type=checkbox]:checked + label,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give_terms_links,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
 					'.mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give-total-wrap .give-currency-symbol,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-donation-level-button-wrap .give-btn.give-default-level,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-gateway-radio-list > li.give-gateway-option-selected label:after,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give_terms_agreement input[type=checkbox]:checked + label:before,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-final-total-wrap .give-donation-total-label,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give-submit' => 'background-color: {{VALUE}};',
 					'.mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-donation-level-button-wrap .give-btn:hover,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give-donation-level-button-wrap .give-btn.give-default-level,
 					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
 					'.mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give_terms_links' => 'box-shadow: 0px 1px 0px {{VALUE}};',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-give-form .give-btn-modal:hover,
					 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna .give-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-give-form .give-btn-modal,
											 ...
											 .mfp-wrap form.elementor-give-modal--skin-grid-coropuna',
			]
		);
          ...
          <div class="give-card__body">
            <?php
              if( '' !== $this->parent->get_instance_value_skin( 'show_category' ) ){
                the_terms( $form_id, 'give_forms_category', '<div class="give-card__category">' .bearsthemes_addons_get_icon_svg( 'location', 14 ) , ',', '</div>' );
              }
