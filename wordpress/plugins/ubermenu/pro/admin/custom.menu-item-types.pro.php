...
function ubermenu_pro_custom_menu_item_types( $items ){
	...
	$items['dynamic_posts'] = array(
		...
		'panels'=> array( 'dynamic_posts' , 'general', 'image' , 'icon', 'badge', 'layout', 'responsive',
		'submenu', 'customize' ),
	);
	...
	$items['dynamic_terms'] = array(
		...
		'panels'=> array( 'dynamic_terms' , 'general' , 'icon' , 'badge', 'layout' , 'responsive' , 'submenu' , 'customize' ),
	);
