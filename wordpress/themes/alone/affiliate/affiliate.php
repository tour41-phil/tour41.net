...
function affiliate_give_add_add_ons_option_link() {
	...
	$submenu['edit.php?post_type=give_forms'][] = [
		...
		'install_plugins',
		esc_url( 'https://givewp.com/addons/category/payment-gateways/ref/434/?campaign=Alonepaymentgateway' ),
	];

  $submenu['edit.php?post_type=give_forms'][] = [
    '<span class="bears-get-addons recurring-payment">Recurring Payment</span>',
		'install_plugins',
		esc_url( 'https://givewp.com/addons/recurring-donations/ref/434/?campaign=Alonepayrecurring' ),
	];

  $submenu['edit.php?post_type=give_forms'][] = [
    '<span class="bears-get-addons must-have-addons">Must have Add-ons</span>',
		'install_plugins',
		esc_url( 'https://givewp.com/addons/ref/434/?campaign=AloneAddons' ),
	];
